  ...
  return (
    <>
      ...
      <div className='w-full flex'>
        <div className="w-[60%] p-20 bg-[#212121] leftside1">
          <h1 className='flex items-center gap-5 justify-start w-full'><span className='w-30 h-[1px] bg-[#c9f31d] flex rounded-[1px]'></span><p className='text-[#c9f31d] text-2xl' style={{fontFamily:"Caveat"}}>Need a Project?</p></h1>
          <h1 className='text-7xl font-thin w-full border-b pb-10 border-gray-600 transition hover:border-[#c9f31d] duration-1000'>Let's work together. Fixed a meeting</h1>
          <div className='w-full flex text-black hover:border-[#c9f31d]  duration-1000 pt-7 gap-5 pb-7 border-b border-gray-600'>
            <span className='p-3 pl-4 pr-4 text-2xl bg-[#c9f31d] rounded-full'>
              <i className="fa-regular fa-envelope"></i>
            </span>
            <div className="w-full flex flex-col justify-between">
              <p className='text-2xl text-[#858585]'>Email</p>
              <p className='text-white'>Sagameperso@gmail.com</p>
            </div>
          </div>
          <div className='w-full flex text-black hover:border-[#c9f31d] transition duration-1000 pt-7 gap-5 pb-7 border-b border-gray-600'>
            <span className='p-3 pl-4 pr-4 text-2xl bg-[#c9f31d] rounded-full'>
              <i className="fa-solid fa-location-dot"></i>
            </span>
            <div className="w-full flex flex-col justify-between">
              <p className='text-2xl text-[#858585]'>Location</p>
              <p className='text-white'>Vizianagaram</p>
            </div>
          </div>
        </div>
        <div className='rightside w-[40%] bg-[#212121] p-15'>
